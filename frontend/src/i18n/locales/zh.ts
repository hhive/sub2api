export default {
  ...
  affiliate: {
    ...
    stats: {
      ...
      tier2: '二级',
      tier3: '三级',
      tierHint: '有效付费邀请 {count} 人，当前倍率 {multiplier}%',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          tieredEnabledHint: '按有效付费邀请人数提高余额与订阅返利比例。仅统计充值、购买订阅或兑换有价值订阅码的被邀请用户。',
          tier2MinPaidInvitees: '二级起始人数',
          tier2MinPaidInviteesHint: '达到该有效付费邀请人数后使用二级倍率。',
          tier3MinPaidInvitees: '三级起始人数',
          tier3MinPaidInviteesHint: '达到该有效付费邀请人数后使用三级倍率，必须高于二级起始人数。',
