  ...
  admin: {
    ...
    settings: {
      ...
      defaults: {
        ...
        firstRechargeBonusEnabledHint: '用户首次成功充值或兑换余额后，额外赠送一次余额',
        firstRechargeBonusAmount: '首次赠送金额',
        firstRechargeBonusAmountHint: '首次成功余额充值或兑换后额外赠送的余额金额',
