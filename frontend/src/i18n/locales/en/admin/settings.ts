    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          tieredEnabled: 'Enable Tiered Rebate',
          tieredEnabledHint: 'Increase balance and subscription rebate rates by rebated invitee count. Counts invitees with positive rebate ledger entries.',
          tier2MinPaidInvitees: 'Tier 2 Starts At',
          tier2MinPaidInviteesHint: 'Use the tier 2 multiplier after this many rebated invitees.',
          tier3MinPaidInvitees: 'Tier 3 Starts At',
          tier3MinPaidInviteesHint: 'Use the tier 3 multiplier after this many rebated invitees; must be higher than tier 2.',
          tier2MultiplierPercent: 'Tier 2 Multiplier',
          tier2MultiplierPercentHint: 'Multiplier relative to the base rebate rate. 120% means base rate × 1.2.',
          tier3MultiplierPercent: 'Tier 3 Multiplier',
          tier3MultiplierPercentHint: 'Multiplier relative to the base rebate rate. 150% means base rate × 1.5.',
      ...
      defaults: {
        ...
        balanceCreditValidityDays: 'Balance Validity (Days)',
      ...
      gatewayForwarding: {
        ...
        deepseekSystemPrompt: 'DeepSeek Gateway System Prompt',
        deepseekSystemPromptPlaceholder: 'Leave empty to disable injection. Non-empty text is appended to the end of the system prompt for DeepSeek upstream text requests.',
        deepseekSystemPromptHint: 'Applies only to DeepSeek upstream requests. The gateway prompt is appended to existing client system/instructions; a new system prompt is created only when the client sends none.',
      ...
      site: {
        ...
        redeemPurchaseUrlPlaceholder: 'https://pay.ldxp.cn/shop/xiaoni-ai',
        redeemPurchaseUrlHint: 'Shown on the user redeem code page. Empty or invalid values fall back to the default purchase URL.',
        siteLogo: 'Site Logo',
      ...
      victoryMenu: {
        title: 'Custom Jump Menus',
        description: 'Configure jump menus shown at the bottom of the regular user navigation and choose whether launches include the user API key.',
        itemLabel: 'Jump Menu #{n}',
        name: 'Menu Name',
