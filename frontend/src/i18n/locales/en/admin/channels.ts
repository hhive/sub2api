export default {
    ...
    tierConfig: {
      ...
      description: 'Configure how users reach each tier and which benefits it grants (tiers with awards can only be disabled)',
      createTier: 'New Tier',
      editTier: 'Edit Tier',
      dragHint: 'Drag the handle on the left to reorder',
      loadFailed: 'Failed to load tier configuration',
      saveFailed: 'Failed to save tier configuration',
      deleteFailed: 'Failed to delete tier',
      orderFailed: 'Failed to save order',
      orderSaved: 'Order saved',
      empty: 'No tiers configured',
      code: 'Tier Code',
      codeLockedHint: 'This tier already has awards, so its code cannot be changed',
      name: 'Name',
      descriptionField: 'Description',
      triggerType: 'Trigger',
      triggerConsumption: 'Reach by accumulated spend',
      triggerFirstRecharge: 'Granted automatically on first recharge',
      thresholdUsd: 'Spend Threshold (USD)',
      thresholdRequired: 'A spend-triggered tier requires a spend threshold',
      enabled: 'Enabled',
      status: 'Status',
      sortOrder: 'Order',
      awardCount: 'Awards',
      benefits: 'Benefits',
      benefitsEmpty: 'This tier has no benefits',
      addBenefit: 'Add Benefit',
      benefitType: 'Benefit Type',
      benefitTypeBalanceCredit: 'Balance Credit',
      benefitTypeGroupRate: 'Group Rate',
      amount: 'Amount',
      ...
      rateMultiplierInvalid: 'Rate multiplier must be greater than 0',
      groupRequired: 'Select a group for the rate benefit',
      deleteTier: 'Delete Tier',
      deleteTierConfirm: 'Delete tier "{name}"? This action cannot be undone.',
      deleteLockedHint: 'Tiers with awards can only be disabled, not deleted.',
      deleteLocked: 'This tier already has awards, so it can only be disabled',
      createSuccess: 'Tier created',
      updateSuccess: 'Tier updated',
      deleteSuccess: 'Tier deleted',
      lookupTitle: 'Look Up User Tier',
      lookupHint: 'Enter a user ID to inspect that user tier state and awards (read-only)',
      userIdPlaceholder: 'User ID',
      lookup: 'Look Up',
      lookupFailed: 'Failed to look up the user tier',
      lookupEmpty: 'Enter a user ID first',
      lookupConsumedAmount: 'Accumulated Spend',
      lookupTiers: 'Tier States',
      lookupAchieved: 'Reached',
      lookupClaimed: 'Claimed',
      lookupClaimable: 'Claimable',
      lookupNotAchieved: 'Not reached',
      lookupAwards: 'Awards',
      lookupNoAwards: 'No awards',
      lookupAwardSource: 'Source',
      lookupAwardAchievedAt: 'Reached At',
      lookupEffects: 'Benefit Effects',
      lookupNoEffects: 'No benefit effects',
