export default {
  ...
  membership: {
    ...
    summaryTitle: 'Current Tier',
    noTier: 'No tier reached yet',
    consumedAmount: 'Accumulated Spend',
    consumedAmountHint: 'Counts redeemed-balance spend only',
    nextTierTitle: 'Next Tier',
    nextTierRemaining: '{amount} to go',
    allTiersTitle: 'Tier Benefits',
    threshold: 'Threshold {amount}',
    firstRechargeAuto: 'Granted automatically on first recharge, no manual claim needed',
    claim: 'Claim',
    claiming: 'Claiming...',
    claimed: 'Claimed',
    claimedAt: 'Claimed at {time}',
    notAchieved: 'Not reached',
    notAchievedRemaining: '{amount} to go',
    benefitAmount: 'Amount {amount}',
    benefitExpiresAt: 'Valid {days} days, until {time}',
    benefitValidityDays: 'Valid {days} days',
    benefitNeverExpires: 'Never expires',
    benefitGroup: 'Group {group}',
    benefitRate: 'Rate {rate}x',
    benefitPending: 'Processing',
    benefitFailed: 'Failed',
    skippedManualRateMultiplier: 'Skipped because a dedicated rate multiplier already exists',
    skippedReason: 'Skipped: {reason}',
    claimAll: 'Claim all unclaimed tiers',
    claimAllNothing: 'No tiers available to claim',
    claimAllSuccess: 'Claimed {count} tiers',
    claimSuccessBalance: '{amount} credited, valid until {expires}',
    claimSuccessRate: '{group} rate applied: {rate}x',
    claimSkippedRate: '{group} rate unchanged: {reason}',
