export default {
  ...
  affiliate: {
    ...
    stats: {
      ...
      tier2: 'Tier 2',
      tier3: 'Tier 3',
      tierHint: '{count} paid invitees, current multiplier {multiplier}%',
      nextTierHint: '{count} more paid invitees to the next tier',
    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          tieredEnabledHint: 'Increase balance and subscription rebate rates by paid invitee count. Counts invitees who recharge, buy a subscription, or redeem a paid subscription code.',
          tier2MinPaidInvitees: 'Tier 2 Starts At',
          tier2MinPaidInviteesHint: 'Use the tier 2 multiplier after this many paid invitees.',
          tier3MinPaidInvitees: 'Tier 3 Starts At',
          tier3MinPaidInviteesHint: 'Use the tier 3 multiplier after this many paid invitees; must be higher than tier 2.',
