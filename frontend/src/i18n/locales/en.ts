export default {
  ...
  affiliate: {
    ...
    stats: {
      rebateRate: 'Balance Subscription Rate',
  ...
  admin: {
    ...
    users: {
      ...
      balanceLedgerTitle: 'User Balance Ledger',
      noBalanceLedger: 'No balance ledger records found',
      ...
      typeBalanceExpired: 'Balance (Expired)',
    ...
    settings: {
      ...
      defaults: {
        ...
        firstRechargeBonusEnabledHint: 'Grant an extra balance once after the user first successfully recharges or redeems balance.',
        firstRechargeBonusAmount: 'First Bonus Amount',
        firstRechargeBonusAmountHint: 'Extra balance granted on the first successful balance recharge or redeem.',
