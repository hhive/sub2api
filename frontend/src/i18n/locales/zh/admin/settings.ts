    ...
    settings: {
      ...
      features: {
        ...
        affiliate: {
          ...
          tieredEnabled: '启用分级返利',
          tieredEnabledHint: '按有效返利邀请人数提高余额与订阅返利比例。统计已产生正数返利流水的被邀请用户。',
          tier2MinPaidInvitees: '二级起始人数',
          tier2MinPaidInviteesHint: '达到该有效返利邀请人数后使用二级倍率。',
          tier3MinPaidInvitees: '三级起始人数',
          tier3MinPaidInviteesHint: '达到该有效返利邀请人数后使用三级倍率，必须高于二级起始人数。',
          tier2MultiplierPercent: '二级倍率',
          tier2MultiplierPercentHint: '相对基础返利比例的倍率。120% 表示基础比例 × 1.2。',
          tier3MultiplierPercent: '三级倍率',
          tier3MultiplierPercentHint: '相对基础返利比例的倍率。150% 表示基础比例 × 1.5。',
      ...
      defaults: {
        ...
        balanceCreditValidityDays: '余额有效期（天）',
        balanceCreditValidityDaysHint: '每笔余额充值或兑换后的独立有效期，0 表示永不过期',
        balanceCreditDailySettlementHour: '日终结算执行时间',
        balanceCreditDailySettlementHourHint: '按服务器本地时间每天执行一次，填 5 表示凌晨 5 点；未配置则不执行余额日终结算',
        firstRechargeBonusEnabled: '首次充值/兑换赠送余额',
        firstRechargeBonusEnabledHint: '用户首次成功充值、兑换余额或兑换订阅后，额外赠送一次余额',
        firstRechargeBonusAmount: '首次赠送金额',
        firstRechargeBonusAmountHint: '首次成功充值、兑换余额或兑换订阅后额外赠送的余额金额',
        firstRechargeBonusValidityDays: '首次赠送有效期（天）',
        firstRechargeBonusValidityDaysHint: '首次赠送余额的独立有效期，0 表示永不过期',
      ...
      gatewayForwarding: {
        ...
        deepseekSystemPrompt: 'DeepSeek 网关系统提示词',
        deepseekSystemPromptPlaceholder: '留空则不注入；填写后会追加到所有 DeepSeek 上游文本请求的系统提示词末尾。',
        deepseekSystemPromptHint: '仅作用于 DeepSeek 上游请求。网关提示词会追加到客户端已有 system/instructions 的末尾；没有客户端系统提示词时才新建 system。',
      ...
      site: {
        ...
        redeemPurchaseUrl: '兑换码购买地址',
        redeemPurchaseUrlHint: '展示在用户兑换码页面，留空或无效时恢复默认购买地址。',
      ...
      victoryMenu: {
        title: '自定义跳转菜单',
        description: '配置显示在普通用户导航栏最下方的跳转菜单，可选择跳转时是否携带用户 API Key。',
        itemLabel: '跳转菜单 #{n}',
        name: '菜单名称',
        namePlaceholder: '如：使用说明文档',
        url: '跳转链接',
