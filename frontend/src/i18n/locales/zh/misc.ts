export default {
  ...
  membership: {
    ...
    noTier: '尚未达成任何等级',
    consumedAmount: '累计消费',
    consumedAmountHint: '口径只统计兑换额度消费',
    nextTierTitle: '下一等级',
    nextTierRemaining: '还差 {amount}',
    allTiersTitle: '各档权益',
    threshold: '门槛 {amount}',
    firstRechargeAuto: '首次充值自动发放，无需手动领取',
    claim: '领取',
    claiming: '领取中...',
    claimed: '已领取',
    claimedAt: '领取于 {time}',
    notAchieved: '未达标',
    notAchievedRemaining: '还差 {amount}',
    benefitAmount: '金额 {amount}',
    benefitExpiresAt: '有效期 {days} 天，至 {time}',
    benefitValidityDays: '有效期 {days} 天',
    benefitNeverExpires: '永不过期',
    benefitGroup: '分组 {group}',
    benefitRate: '倍率 {rate}x',
    benefitPending: '发放中',
    benefitFailed: '发放失败',
    skippedManualRateMultiplier: '因已有专属倍率而跳过',
    skippedReason: '已跳过：{reason}',
    claimAll: '一键领取全部未领档位',
    claimAllNothing: '没有可领取的档位',
    claimAllSuccess: '已领取 {count} 个档位',
    claimSuccessBalance: '{amount} 已到账，有效期至 {expires}',
    claimSuccessRate: '{group} 倍率已生效：{rate}x',
    claimSkippedRate: '{group} 倍率未变更：{reason}',
    claimFailed: '领取失败',
