...
func TestAdminService_UpdateUserBalance_UsesAtomicPrimitives(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			user, err := svc.UpdateUserBalance(context.Background(), 7, tt.amount, tt.operation, "", nil)
...
func TestAdminService_UpdateUserBalance_RejectsNegativeResult(t *testing.T) {
	...
	_, err := svc.UpdateUserBalance(context.Background(), 7, 4, "subtract", "", nil)
	require.Error(t, err)
...
func TestAdminService_UpdateUserBalance_RejectsUnknownOperation(t *testing.T) {
	...
	_, err := svc.UpdateUserBalance(context.Background(), 7, 1, "multiply", "", nil)
	require.Error(t, err)
