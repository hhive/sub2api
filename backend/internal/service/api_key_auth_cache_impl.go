...
const apiKeyAuthSnapshotVersion = 15 // v15: include custom model/exclusive group authorization, group peak rate, video pricing, and web search per-call pricing
