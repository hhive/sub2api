...
const (
	...
	SettingKeyImagePlaygroundDocURL         = "image_playground_doc_url"         // 图片生成站文档链接
	SettingKeyVideoPlaygroundDocURL         = "video_playground_doc_url"         // 视频生成站文档链接
	SettingKeyRedeemPurchaseURL             = "redeem_purchase_url"              // 兑换码购买地址
	...
	SettingKeyVideoPlaygroundEnabled        = "video_playground_enabled"         // 是否启用独立视频生成站
	SettingKeyVideoPlaygroundBaseURL        = "video_playground_base_url"        // 独立视频生成站访问地址
	SettingKeyVideoPlaygroundMenuLabel      = "video_playground_menu_label"      // 独立视频生成站菜单显示名称
	SettingKeyVideoPlaygroundExchangeSecret = "video_playground_exchange_secret" // 独立视频生成站后端交换密钥
