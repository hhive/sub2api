...
func (s *GatewayService) recordUsageCore(ctx context.Context, input *recordUsageCoreInput, opts *recordUsageOpts) error {
	...
	effectiveMultiplier, effectiveImageMultiplier := computePeakAwareMultipliers(apiKey, effectiveMultiplier, timezone.Now())
	...
	// 计算费用
	cost := s.calculateRecordUsageCost(ctx, result, apiKey, billingModel, effectiveMultiplier, effectiveImageMultiplier, opts)
