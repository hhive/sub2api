...
func ProvideAdminSettingHandler(settingService *service.SettingService, emailService *service.EmailService, turnstileService *service.TurnstileService, opsService *service.OpsService, paymentConfigService *service.PaymentConfigService, paymentService *service.PaymentService, balanceExpiryService *service.BalanceExpiryService, userAttributeService *service.UserAttributeService, notificationEmailService *service.NotificationEmailService) *admin.SettingHandler {
	h := admin.NewSettingHandler(settingService, emailService, turnstileService, opsService, paymentConfigService, paymentService, balanceExpiryService, userAttributeService)
	h.SetNotificationEmailService(notificationEmailService)
	return h
}

// ProvideAPIKeyHandler creates APIKeyHandler with optional gateway-backed model metadata.
func ProvideAPIKeyHandler(apiKeyService *service.APIKeyService, gatewayService *service.GatewayService) *APIKeyHandler {
	return NewAPIKeyHandler(apiKeyService, gatewayService)
}
