...
type UpdateSettingsRequest struct {
	...
	DeepSeekSystemPrompt                   *string `json:"deepseek_system_prompt"`
...
func (h *SettingHandler) UpdateSettings(c *gin.Context) {
	...
	settings := &service.SystemSettings{
		...
		DeepSeekSystemPrompt: func() string {
			if req.DeepSeekSystemPrompt != nil {
				return *req.DeepSeekSystemPrompt
			}
			return previousSettings.DeepSeekSystemPrompt
		}(),
	...
	payload := dto.SystemSettings{
		...
		ComplianceNoticeEnabled:                                updatedSettings.ComplianceNoticeEnabled,
		ComplianceNoticeRevision:                               updatedSettings.ComplianceNoticeRevision,
		ComplianceNoticeBadge:                                  updatedSettings.ComplianceNoticeBadge,
		ComplianceNoticeTitle:                                  updatedSettings.ComplianceNoticeTitle,
		ComplianceNoticeContentMD:                              updatedSettings.ComplianceNoticeContentMD,
		ComplianceNoticeAcceptText:                             updatedSettings.ComplianceNoticeAcceptText,
		ComplianceNoticeDeclineText:                            updatedSettings.ComplianceNoticeDeclineText,
		...
		DeepSeekSystemPrompt:                                   updatedSettings.DeepSeekSystemPrompt,
