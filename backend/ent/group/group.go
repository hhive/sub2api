...
const (
	...
	// FieldRateCorrectionMultiplier holds the string denoting the rate_correction_multiplier field in the database.
	FieldRateCorrectionMultiplier = "rate_correction_multiplier"
...
var (
	...
	// DefaultRateCorrectionMultiplier holds the default value on creation for the "rate_correction_multiplier" field.
	DefaultRateCorrectionMultiplier float64
...
// ByRateCorrectionMultiplier orders the results by the rate_correction_multiplier field.
func ByRateCorrectionMultiplier(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldRateCorrectionMultiplier, opts...).ToFunc()
}
