...
func init() {
	...
	// groupDescRateCorrectionMultiplier is the schema descriptor for rate_correction_multiplier field.
	groupDescRateCorrectionMultiplier := groupFields[3].Descriptor()
	// group.DefaultRateCorrectionMultiplier holds the default value on creation for the rate_correction_multiplier field.
	group.DefaultRateCorrectionMultiplier = groupDescRateCorrectionMultiplier.Default.(float64)
