...
func init() {
	...
	// announcementDescSite is the schema descriptor for site field.
	announcementDescSite := announcementFields[3].Descriptor()
	// announcement.DefaultSite holds the default value on creation for the site field.
	announcement.DefaultSite = announcementDescSite.Default.(string)
	// announcement.SiteValidator is a validator for the "site" field. It is called by the builders before save.
	announcement.SiteValidator = announcementDescSite.Validators[0].(func(string) error)
