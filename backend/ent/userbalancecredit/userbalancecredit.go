...
const (
	// Label holds the string label denoting the userbalancecredit type in the database.
	Label = "user_balance_credit"
	...
	// FieldSettledUntilDate holds the string denoting the settled_until_date field in the database.
	FieldSettledUntilDate = "settled_until_date"
	...
	EdgeUser = "user"
	// Table holds the table name of the userbalancecredit in the database.
	Table = "user_balance_credits"
	// UserTable is the table that holds the user relation/edge.
	UserTable = "user_balance_credits"
...
// Columns holds all SQL columns for userbalancecredit fields.
var Columns = []string{
	FieldID,
	FieldUserID,
	FieldSourceType,
...
var (
	...
	// DefaultSourceCode holds the default value on creation for the "source_code" field.
...
// OrderOption defines the ordering options for the UserBalanceCredit queries.
...
// BySettledUntilDate orders the results by the settled_until_date field.
func BySettledUntilDate(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldSettledUntilDate, opts...).ToFunc()
}
